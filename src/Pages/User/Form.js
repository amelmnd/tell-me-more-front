  ...
  return isLoading && !data ? (
    ...
    <Formiz connect={myForm} onSubmit={handleSubmit}>
      ...
      >
          ...
          return (
            <FormizStep key={_id} name={step} placeholder={question}>
              ...
              {type === "radio" ? (
                ...
                <FieldCheckbox name={question} label={question} value={false} />
              ) : (
                <Field name={question} label={question} type={type} />
              )}
            </FormizStep>
          );
        })}
        ...
        {!myForm.isFirstStep &&
          !myForm.isLastStep &&
          myForm.currentStep?.index !== dataQuestions.length && (
            <button type="submit" disabled={!myForm.isStepValid}>
              Suivant
            </button>
          )}
